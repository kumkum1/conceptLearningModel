...
def get_concept_dataset_dic_and_AM_initial_weights_lst(BBSR_path):
    ...
    corr_dataset = df_BBSR.drop(columns=["Concept"]).corr(method=method_type)
...
if __name__ == "__main__":
    ...
    BBSR_path = "./data/processedData/LC823_Merged.xlsx"
    # AM_binarycode_file = create ( "../results/AM_binarycode.pickle", "wb")
